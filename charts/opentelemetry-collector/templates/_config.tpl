...
{{- if and (.Values.presets.clusterMetrics.customMetrics) (.Values.presets.clusterMetrics.customMetrics.enabled) }}
{{- if and ($config.service.pipelines.metrics) (not (has "metricstransform/k8s-dashboard" $config.service.pipelines.metrics.processors)) }}
...
{{- end }}
{{- if and ($config.service.pipelines.metrics) (not (has "transform/k8s-dashboard" $config.service.pipelines.metrics.processors)) }}
