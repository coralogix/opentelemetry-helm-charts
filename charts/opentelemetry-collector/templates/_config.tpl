...
{{- end }}
{{- if and ($config.service.pipelines.profiles) (has "batch" $config.service.pipelines.profiles.processors) }}
{{- $_ := set $config.service.pipelines.profiles "processors" (without $config.service.pipelines.profiles.processors "batch" | uniq)  }}
{{- $_ := set $config.service.pipelines.profiles "processors" (append $config.service.pipelines.profiles.processors "batch" | uniq)  }}
{{- end }}
